...
INSERT INTO sys_role (role, role_name, `function`) VALUES ('TEACHER', 'Teacher', 'CREATE_COURSE,VIEW_AND_ENROLL');
INSERT INTO sys_role (role, role_name, `function`) VALUES ('STUDENT', 'Student', 'VIEW_AND_ENROLL');
...
('lecturer01', 'Dr. Smith', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOnu', 'TEACHER', 'Expert in Software Engineering with 20 years experience.', 'Java Development'),
('user01', 'John Doe', '$2a$10$8.UnVuG9HHgffUDAlk8qfOuVGkqRzgVymGe07xd00DMxs.TVuHOnu', 'STUDENT', NULL, NULL);
